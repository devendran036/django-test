"""
Django settings for devpychatupdated project.
...
SECRET_KEY = 'django-insecure-50(rjt7b7!1-vk9=tawntuw+ktyr(r=5lul0bld!gsl6*(*$f8'
...
ROOT_URLCONF = 'devpychatupdated.urls'
STATIC_URL='/static/'
TEMPLATES = [
    {
